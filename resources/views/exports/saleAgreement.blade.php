...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        @if($data->booking_line_item->booking_type->reference_value_text =="Niches")
          ...
          <!-- dsddsa -->
              @if(!empty($data->booking_line_item->information[1]))
                  <div style="width: 10%; font-size: 11px; padding-right:20px; padding-top: 7px; float:left">
                  ...
                  <!-- <div style="clear: both"></div> -->
                  <div style="width: 10%; font-size: 11px; padding-right:20px; padding-top: 8px; float:left;margin-top: 15px;">
                      <div>Occupant</div>
                      <div style="padding-left: 6px;">{{$data->booking_line_item->niche->reference_no}}</div>
                  </div>
                  <div style="float:left;width: 37%;margin-top: 15px;">
                      ...
                      <br/>
                      <div style="font-size: 11px; line-height: 1.5">
                      {{$data->booking_line_item->information[1]->relationship_to_applicant}} {{$data->booking_line_item->information[1]->death_anniversary}}
                      </div>
                  </div>
                  <div style="clear: both"></div>
              @endif
      ...
      <div class="px-20" style="margin-top: 22px; font-size: 11px; line-height: 16px;">Services</div>
