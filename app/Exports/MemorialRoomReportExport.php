...
class MemorialRoomReportExport implements FromView
{
    ...
    public function view(): View
    {
            ...
            $query->with(['invoice_line_item' => function($q){
                $q->with(['sale_agreement_line_item' => function($_q){
                    $_q->with(['booking_line_item' => function($_q1){
                        $_q1->with('room', 'funeral_director', "booking_type");
                    }]);
                }]);
            }]);
        }])
        ...
        return view('exports.memorial-room-report', compact('collections'));
    }
}
